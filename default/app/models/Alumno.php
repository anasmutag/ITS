...
class Alumno extends ActiveRecord {
    public function cargarDatosAlumno($id) {
        return $this->find("columns: alumno.id_alumno,abreviatura_tipodocumento,identificacion_alumno,nombre_alumno,apellido_alumno,nombre_programa",
    ...
    public function cargarIdAlumno($id) {
